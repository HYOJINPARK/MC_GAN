...
parser.add_argument('--fasttext_model', type=str, default='text_bin/wiki.en.bin',
                    help='pretrained fastText model (binary file)')
parser.add_argument('--save_filename', type=str, default='pth_models/0419text_embedding_flower.pth',
